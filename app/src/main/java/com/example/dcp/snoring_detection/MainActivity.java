package com.example.dcp.snoring_detection;
...
public class MainActivity extends AppCompatActivity {
    ...
    TextView textView,audioLevel,threshold;
    ...
    protected void onCreate(Bundle savedInstanceState) {
                    ...
                    while (runner != null){
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                threshold.setText("Threshold = "+Double.toString(Threshold)+"dB");
                                if(db>=Threshold){
                                    audioLevel.setText("Threshold exceeded snoring detected");
                                }
                                else{
                                    audioLevel.setText("No snoring detected");
                                }
        ...
        buttonPlayLastRecordAudio.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) throws IllegalArgumentException,
                ...
                mediaPlayer.start();
                Toast.makeText(MainActivity.this, "Playing the Record",
                        Toast.LENGTH_LONG).show();
            }
        });
